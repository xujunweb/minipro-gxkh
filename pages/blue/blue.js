...
Page({
  ...
  //通过api开启蓝牙
  bluetext:function(){
    var pwd = "050106303030303030FFFFFFFFAEAEAE"
    ...
    wx.getBLEDeviceCharacteristics({
      ...
      success: function (res) {
        for (var i = 0; i < res.characteristics.length; i++) {
          if (res.characteristics[i].uuid === '0000FEC8-0000-1000-8000-00805F9B34FB') {
          ...
          if (res.characteristics[i].uuid === '0000FEC7-0000-1000-8000-00805F9B34FB') {
            that.setData({
              writeServicweId: that.data.services[0].uuid,
              writeCharacteristicsId: res.characteristics[i].uuid,
            })

          } else if (res.characteristics[i].uuid === '0000FEC9-0000-1000-8000-00805F9B34FB') {
            that.setData({
  ...
  lanya8: function () {
    ...
    var buf = that.hexString2ArrayBuffer(16)
  ...
  * 16进制字符串转ArrayBuffer
  */
  hexString2ArrayBuffer: function (hexStr) {
